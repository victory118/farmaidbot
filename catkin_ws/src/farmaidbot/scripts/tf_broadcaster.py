...
class TfBroadcaster:
    ...
    def broadcast(self):
        ...
        for tag_id, tf_data in self.tag_info.iteritems():
            ...
            tf_w2t.header.frame_id = "map"
            tf_w2t.child_frame_id = "apriltag" + str(tag_id)
    ...
    def callback(self, pose_array):
        ...
        for i in range(len(pose_array.detections)):
            ...
            tf_c2t.child_frame_id = "apriltag" + str(tag_id)
            ...
            tf_w2r.header.frame_id = "map"
            tf_w2r.child_frame_id = "base_link"
