...
if __name__ == '__main__':
    rospy.init_node('apriltag_localization', anonymous=True)
    ...
    apriltag_localization = AprilTagLocalization(tag_poses, poselist_base2cam)
    rospy.sleep(0.5)
    ...
    while not rospy.is_shutdown():
        # publish_transforms()
        apriltag_localization.broadcast_static_tf()
        print "pose_detections = ", apriltag_localization.get_measurement()
        rate.sleep()
